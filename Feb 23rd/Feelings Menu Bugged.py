...
class Welcome_Screen(tk.Frame):
    def __init__(self, root):
        ...
        win_text = tk.Label(self,
                            text="This program will cure any unwanted feelings instantly with radical new treatment : Witty quotes.",
...
class Feeling_Selection_Screen(tk.Frame):
    def __init__(self, root):
        ...
        for feeling in feelings:
            feeling_buttons.append(Defualt_Button(self, lambda: create_change_feeling_frame(self, feeling_quote,
                                                                                            feelings[str(feeling)][
